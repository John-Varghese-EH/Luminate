...
export default function Flashcard({ question, answer }: FlashcardProps) {
  ...
  return (
    <div
      ...
      role="button"
      tabIndex={0}
      aria-label={`Flashcard: ${isFlipped ? 'Showing answer' : 'Showing question'}. ${isFlipped ? answer : question}. Press Enter to flip.`}
    >
      <div
      ...
      >
        ...
        >
          ...
          <div className="absolute top-6 right-6 flex gap-1.5 opacity-50" aria-hidden="true">
        ...
        <div 
          ...
          aria-hidden={!isFlipped}
        >
          <div className="absolute top-6 left-6 w-10 h-10 bg-white/10 rounded-2xl flex items-center justify-center border border-white/10 backdrop-blur-md" aria-hidden="true">
            <i className="fa-solid fa-lightbulb text-white" aria-hidden="true"></i>
          </div>
